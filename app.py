...
<div class="main-header">
    ...
    <p>Tác giả: cam Thị Thuyên - Trường Tiểu học Vĩnh Hảo - ĐT: 0946070971</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Cam Thị Thuyên - Trường Tiểu học Vĩnh Hảo - ĐT: 0946070971 </div>", unsafe_allow_html=True)
